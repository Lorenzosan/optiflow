...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("final_battery_soc", sa.Float(), nullable=False),
        ...
        sa.Column("battery_charge_steps", sa.Integer(), nullable=False),
        sa.Column("battery_discharge_steps", sa.Integer(), nullable=False),
